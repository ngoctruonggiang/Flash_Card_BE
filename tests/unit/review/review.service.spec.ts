...
describe('ReviewService  Tests', () => {
  ...
  describe('updateReview', () => {
    it('TC-REVIEW-001: should update a review', async () => {
    ...
    it('TC-REVIEW-002: should handle review with all fields', async () => {
      const mockReview: any = {
        id: 1,
        cardId: 1,
        quality: 'Easy',
    ...
    it('TC-REVIEW-003: should throw error for non-existent review', async () => {
  ...
  describe('removeByCardId', () => {
    it('TC-REVIEW-004: should remove all reviews for a card', async () => {
    ...
    it('TC-REVIEW-005: should return count 0 when no reviews exist', async () => {
    ...
    it('TC-REVIEW-006: should handle cardId = 0', async () => {
      mockPrismaService.cardReview.deleteMany.mockResolvedValue({ count: 0 });
    ...
    it('TC-REVIEW-007: should handle negative cardId', async () => {
      mockPrismaService.cardReview.deleteMany.mockResolvedValue({ count: 0 });
  ...
  describe('addReview', () => {
    it('TC-REVIEW-008: should create a new review', async () => {
      const mockReview: any = {
        cardId: 1,
        quality: 'Good',
        repetitions: 0,
    ...
    it('TC-REVIEW-009: should handle all quality types', async () => {
    ...
    it('TC-REVIEW-010: should handle all status transitions', async () => {
  ...
  describe('getLastestReviewByCardId', () => {
    it('TC-REVIEW-011: should return the latest review', async () => {
      const mockReview = {
        id: 1,
        cardId: 1,
    ...
    it('TC-REVIEW-012: should return null when no reviews exist', async () => {
    ...
    it('TC-REVIEW-013: should order by reviewedAt desc', async () => {
      mockPrismaService.cardReview.findFirst.mockResolvedValue(null);
  ...
  describe('submitCramReviews', () => {
    it('TC-REVIEW-014: should create review without updating card schedule', async () => {
      const submitDto: any = {
        CardReviews: [{ cardId: 1, quality: 'Good' }],
      };
      const mockCard = {
    ...
    it('TC-REVIEW-015: should throw NotFoundException for non-existent cards', async () => {
      const submitDto: any = {
        CardReviews: [{ cardId: 999, quality: 'Good' }],
      };
      mockPrismaService.card.findUnique.mockResolvedValue(null);
    ...
    it('TC-REVIEW-016: should preserve card status in review', async () => {
      const submitDto: any = {
        CardReviews: [{ cardId: 1, quality: 'Good' }],
      };
      const mockCard = {
    ...
    it('TC-REVIEW-017: should use custom reviewedAt if provided', async () => {
    ...
    it('TC-REVIEW-018: should handle multiple cram reviews', async () => {
      const submitDto: any = {
        CardReviews: [
          { cardId: 1, quality: 'Good' },
          { cardId: 2, quality: 'Easy' },
  ...
  describe('getDueReviews', () => {
    ...
    it('TC-REVIEW-019: should return due cards', async () => {
      const mockCards = [
    ...
    it('TC-REVIEW-020: should return empty array when no cards due', async () => {
    ...
    it('TC-REVIEW-021: should respect limit parameter', async () => {
      mockPrismaService.card.findMany.mockResolvedValue([]);
    ...
    it('TC-REVIEW-022: should order by nextReviewDate asc', async () => {
      mockPrismaService.card.findMany.mockResolvedValue([]);
    ...
    it('TC-REVIEW-023: should include new cards', async () => {
      mockPrismaService.card.findMany.mockResolvedValue([]);
    ...
    it('TC-REVIEW-024: should include learning cards', async () => {
      mockPrismaService.card.findMany.mockResolvedValue([]);
    ...
    it('TC-REVIEW-025: should include relearning cards', async () => {
      mockPrismaService.card.findMany.mockResolvedValue([]);
    ...
    it('TC-REVIEW-026: should throw NotFoundException when deck does not exist', async () => {
  ...
  describe('getReviewPreview', () => {
    it('TC-REVIEW-027: should return preview for all quality options', async () => {
      const mockCard = {
        id: 1,
        status: 'learning',
        stepIndex: 0,
    ...
    it('TC-REVIEW-028: should throw NotFoundException for non-existent card', async () => {
      mockPrismaService.card.findUnique.mockResolvedValue(null);
    ...
    it('TC-REVIEW-029: should format intervals in minutes for learning cards', async () => {
      const mockCard = {
        id: 1,
        status: 'learning',
        stepIndex: 0,
    ...
    it('TC-REVIEW-030: should format intervals in days for review cards', async () => {
      const mockCard = {
        id: 1,
        status: 'review',
        stepIndex: 0,
    ...
    it('TC-REVIEW-031: should handle singular day', async () => {
      const mockCard = {
        id: 1,
        status: 'review',
        stepIndex: 0,
    ...
    it('TC-REVIEW-032: should handle plural days', async () => {
      const mockCard = {
        id: 1,
        status: 'review',
        stepIndex: 0,
